...
OW_out_dens_3par_PS1<-matrix(NA,nrow=780,ncol=ntri)
...
OW_out_dens_3par_PS2<-matrix(NA,nrow=780,ncol=ntri)
...
OW_out_dens_3par_PS3<-matrix(NA,nrow=780,ncol=ntri)
...
OW_out_dens_3par_PS4<-matrix(NA,nrow=780,ncol=ntri)
