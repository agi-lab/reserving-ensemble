...
boxplot(relative_diff_centralBias)
boxplot(relative_diff_75Bias)
...
plot(x=corres_splitpoints_SLPincluded, y=mean_reserve_bias[-c(EW_ind, BMV_ind)],
     ...
     ylim = c(min(mean_reserve_bias), max(mean_reserve_bias)))
...
plot(x=corres_splitpoints_SLPincluded, y=reserve_bias_75Quantile[-c(EW_ind, BMV_ind)],
     ...
     ylim = c(min(reserve_bias_75Quantile), max(reserve_bias_75Quantile)))
